...
exports.DatabaseModule = exports.DB_POOL = exports.DRIZZLE = void 0;
...
exports.DB_POOL = Symbol('DB_POOL');
    ...
    (0, common_1.Module)({
        providers: [
            ...
            },
            {
                ...
                inject: [exports.DB_POOL],
                useFactory: (pool) => {
                    return (0, node_postgres_1.drizzle)(pool, { schema });
                },
            },
        ],
        exports: [exports.DRIZZLE, exports.DB_POOL],
    })
], DatabaseModule);
